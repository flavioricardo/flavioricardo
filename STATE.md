...
**De volta ao ar em 2026-09-11.** `index.html` restaurado a partir do commit `012b928` (o mesmo estado anterior ao placeholder), via `git checkout 012b928 -- index.html`. Tudo abaixo descreve o site completo.
